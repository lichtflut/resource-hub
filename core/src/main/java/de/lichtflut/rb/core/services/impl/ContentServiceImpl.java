...
public class ContentServiceImpl implements ContentService {
	...
	public ContentItem findById(final String id) {
		...
		ResourceNode resource = conversation().findResource(QualifiedName.from(id));
	...
	public void attachToResource(final ContentItem contentItem, final ResourceID target) {
		ResourceNode resource = conversation().findResource(QualifiedName.from(contentItem.getID()));
		if (resource != null) {
