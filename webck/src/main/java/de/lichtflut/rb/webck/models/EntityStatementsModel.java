 ...
 */
public class EntityStatementsModel extends AbstractDerivedListModel<Statement, RBEntity> {
	 ...
	 * @param source
	 */
	public EntityStatementsModel(IModel<RBEntity> source, RelationshipFilter filter) {
		super(source);
		this.filter = filter;
	}
